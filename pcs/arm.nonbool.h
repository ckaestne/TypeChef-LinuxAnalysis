...
#undef CONFIG_ARM_L1_CACHE_SHIFT
#if (defined(CONFIG_ARCH_OMAP3) || defined(CONFIG_ARCH_S5PC1XX))
...
#undef CONFIG_AT91_TIMER_HZ
#if (defined(CONFIG_ARCH_AT91) && defined(CONFIG_ARCH_AT91RM9200))
...
#undef CONFIG_CPU_DCACHE_SIZE
#if defined(CONFIG_CPU_ARM740T)
  #define CONFIG_CPU_DCACHE_SIZE 0x00001000
#endif
#if (!defined(CONFIG_CPU_ARM740T) && defined(CONFIG_CPU_ARM946E))
  #define CONFIG_CPU_DCACHE_SIZE 0x00002000
#endif
...
#undef CONFIG_HZ
#if (defined(CONFIG_ARCH_L7200) || (defined(CONFIG_OMAP_32K_TIMER) && !defined(CONFIG_ARCH_EBSA110) && !defined(CONFIG_ARCH_S3C2410) && defined(CONFIG_ARCH_OMAP)) || (!defined(CONFIG_ARCH_EBSA110) && defined(CONFIG_ARCH_AT91RM9200) && defined(CONFIG_ARCH_AT91) && !defined(CONFIG_ARCH_L7200) && !defined(CONFIG_ARCH_S3C2410) && (!defined(CONFIG_ARCH_OMAP) || !defined(CONFIG_OMAP_32K_TIMER))))
...
#endif
#if ((!defined(CONFIG_ARCH_EBSA110) && defined(CONFIG_ARCH_AT91) && (!defined(CONFIG_ARCH_AT91) || !defined(CONFIG_ARCH_AT91RM9200)) && !defined(CONFIG_ARCH_L7200) && !defined(CONFIG_ARCH_S3C2410) && (!defined(CONFIG_ARCH_OMAP) || !defined(CONFIG_OMAP_32K_TIMER))) || (!defined(CONFIG_ARCH_EBSA110) && !defined(CONFIG_ARCH_AT91) && (!defined(CONFIG_ARCH_AT91) || !defined(CONFIG_ARCH_AT91RM9200)) && !defined(CONFIG_ARCH_L7200) && !defined(CONFIG_ARCH_S3C2410) && (!defined(CONFIG_ARCH_OMAP) || !defined(CONFIG_OMAP_32K_TIMER))))
...
#define CONFIG_MACH_U300_ACCESS_MEM_SIZE 13

#define CONFIG_MAX_RAW_DEVS 256

#define CONFIG_MG_DISK_RES 0

#undef CONFIG_MSM_DEBUG_UART
#if (defined(CONFIG_ARCH_MSM) && defined(CONFIG_MSM_DEBUG_UART1))
  #define CONFIG_MSM_DEBUG_UART 1
#endif
#if (defined(CONFIG_ARCH_MSM) && defined(CONFIG_MSM_DEBUG_UART2) && (!defined(CONFIG_ARCH_MSM) || !defined(CONFIG_MSM_DEBUG_UART1)))
  #define CONFIG_MSM_DEBUG_UART 2
#endif
#if (defined(CONFIG_ARCH_MSM) && defined(CONFIG_MSM_DEBUG_UART3) && (!defined(CONFIG_ARCH_MSM) || !defined(CONFIG_MSM_DEBUG_UART2)) && (!defined(CONFIG_ARCH_MSM) || !defined(CONFIG_MSM_DEBUG_UART1)))
...
#if (defined(CONFIG_NEED_MULTIPLE_NODES) && defined(CONFIG_ARCH_LH7A40X))
...
#endif
#if (defined(CONFIG_VMSPLIT_2G) && !defined(CONFIG_VMSPLIT_1G))
  #define CONFIG_PAGE_OFFSET 0x80000000
#endif
#if (!defined(CONFIG_VMSPLIT_1G) && !defined(CONFIG_VMSPLIT_2G))
...
#define CONFIG_PROCESSOR_ID 0x00007700
...
#define CONFIG_S3C2410_PM_CHECK_CHUNKSIZE 64

#undef CONFIG_S3C24XX_GPIO_EXTRA
#if (defined(CONFIG_PLAT_S3C24XX) && defined(CONFIG_S3C24XX_GPIO_EXTRA128))
  #define CONFIG_S3C24XX_GPIO_EXTRA 128
#endif
#if (defined(CONFIG_PLAT_S3C24XX) && defined(CONFIG_S3C24XX_GPIO_EXTRA64) && (!defined(CONFIG_PLAT_S3C24XX) || !defined(CONFIG_S3C24XX_GPIO_EXTRA128)))
  #define CONFIG_S3C24XX_GPIO_EXTRA 64
#endif
#if ((!defined(CONFIG_PLAT_S3C24XX) || !defined(CONFIG_S3C24XX_GPIO_EXTRA64)) && (!defined(CONFIG_PLAT_S3C24XX) || !defined(CONFIG_S3C24XX_GPIO_EXTRA128)) && defined(CONFIG_PLAT_S3C24XX))
...
#if (defined(CONFIG_PLAT_S3C) && (defined(CONFIG_ARCH_S3C64XX) || defined(CONFIG_CPU_S3C2443) || defined(CONFIG_ARCH_S5PC1XX)) && defined(CONFIG_ARM) && defined(CONFIG_HAS_IOMEM))
  #define CONFIG_SERIAL_SAMSUNG_UARTS 4
#endif
#if (defined(CONFIG_ARM) && defined(CONFIG_PLAT_S3C) && defined(CONFIG_HAS_IOMEM) && (!defined(CONFIG_PLAT_S3C) || (!defined(CONFIG_ARCH_S3C64XX) && !defined(CONFIG_CPU_S3C2443) && !defined(CONFIG_ARCH_S5PC1XX)) || !defined(CONFIG_ARM) || !defined(CONFIG_HAS_IOMEM)))
...
#if (defined(CONFIG_DEBUG_SPINLOCK) || defined(CONFIG_DEBUG_LOCK_ALLOC) || (defined(CONFIG_ARM) && !defined(CONFIG_CPU_CACHE_VIPT)))
...
#undef CONFIG_VECTORS_BASE
#if (defined(CONFIG_MMU) || defined(CONFIG_CPU_HIGH_VECTOR))
  #define CONFIG_VECTORS_BASE 0xffff0000
#endif
#if (!defined(CONFIG_MMU) && !defined(CONFIG_CPU_HIGH_VECTOR) && defined(CONFIG_REMAP_VECTORS_TO_RAM))
  #define CONFIG_VECTORS_BASE DRAM_BASE
#endif
#if (!defined(CONFIG_MMU) && !defined(CONFIG_CPU_HIGH_VECTOR) && !defined(CONFIG_REMAP_VECTORS_TO_RAM))
...
#define CONFIG_ZBOOT_ROM_BSS 0

#define CONFIG_ZBOOT_ROM_TEXT 0
