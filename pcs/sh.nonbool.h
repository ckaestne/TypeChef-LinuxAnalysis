...
#endif
#if (defined(CONFIG_SUPERH64) && !defined(CONFIG_SUPERH32))
  #define CONFIG_ARCH_DEFCONFIG "arch/sh/configs/cayman_defconfig"
#endif
...
#undef CONFIG_BOOT_LINK_OFFSET
#if (!defined(CONFIG_SH_SHMIN) && !defined(CONFIG_SH_CAYMAN) && defined(CONFIG_SH_7780_SOLUTION_ENGINE))
  #define CONFIG_BOOT_LINK_OFFSET 0x00810000
#endif
#if (!defined(CONFIG_SH_7780_SOLUTION_ENGINE) && !defined(CONFIG_SH_SHMIN) && !defined(CONFIG_SH_TITAN) && !defined(CONFIG_SH_CAYMAN) && defined(CONFIG_SH_EDOSK7760) && !defined(CONFIG_SH_SDK7780))
  #define CONFIG_BOOT_LINK_OFFSET 0x02000000
#endif
#if (!defined(CONFIG_SH_7780_SOLUTION_ENGINE) && !defined(CONFIG_SH_SHMIN) && !defined(CONFIG_SH_TITAN) && !defined(CONFIG_SH_CAYMAN) && !defined(CONFIG_SH_EDOSK7760) && !defined(CONFIG_SH_SDK7780))
  #define CONFIG_BOOT_LINK_OFFSET 0x00800000
#endif
#if (!defined(CONFIG_SH_SHMIN) && !defined(CONFIG_SH_CAYMAN) && !defined(CONFIG_SH_7780_SOLUTION_ENGINE) && defined(CONFIG_SH_TITAN))
  #define CONFIG_BOOT_LINK_OFFSET 0x009e0000
#endif
#if (defined(CONFIG_SH_CAYMAN) && !defined(CONFIG_SH_SHMIN))
  #define CONFIG_BOOT_LINK_OFFSET 0x00400000
#endif
#if (!defined(CONFIG_SH_7780_SOLUTION_ENGINE) && !defined(CONFIG_SH_SHMIN) && !defined(CONFIG_SH_TITAN) && !defined(CONFIG_SH_CAYMAN) && defined(CONFIG_SH_SDK7780))
  #define CONFIG_BOOT_LINK_OFFSET 0x01800000
#endif
#if defined(CONFIG_SH_SHMIN)
  #define CONFIG_BOOT_LINK_OFFSET 0x00210000
#endif
...
#define CONFIG_CMDLINE "console=ttySC1,115200"
...
#undef CONFIG_ENTRY_OFFSET
#if (!defined(CONFIG_PAGE_SIZE_4KB) && !defined(CONFIG_PAGE_SIZE_8KB) && !defined(CONFIG_PAGE_SIZE_16KB) && defined(CONFIG_PAGE_SIZE_64KB))
  #define CONFIG_ENTRY_OFFSET 0x00010000
#endif
#if (!defined(CONFIG_PAGE_SIZE_4KB) && !defined(CONFIG_PAGE_SIZE_8KB) && !defined(CONFIG_PAGE_SIZE_16KB) && !defined(CONFIG_PAGE_SIZE_64KB))
  #define CONFIG_ENTRY_OFFSET 0x00000000
#endif
#if (!defined(CONFIG_PAGE_SIZE_4KB) && !defined(CONFIG_PAGE_SIZE_8KB) && defined(CONFIG_PAGE_SIZE_16KB))
  #define CONFIG_ENTRY_OFFSET 0x00004000
#endif
#if defined(CONFIG_PAGE_SIZE_4KB)
  #define CONFIG_ENTRY_OFFSET 0x00001000
#endif
#if (defined(CONFIG_PAGE_SIZE_8KB) && !defined(CONFIG_PAGE_SIZE_4KB))
  #define CONFIG_ENTRY_OFFSET 0x00002000
#endif
...
#endif
#if (defined(CONFIG_PAGE_SIZE_64KB) && !defined(CONFIG_PAGE_SIZE_16KB))
  #define CONFIG_FORCE_MAX_ZONEORDER 7
#endif
#if (!defined(CONFIG_PAGE_SIZE_16KB) && !defined(CONFIG_PAGE_SIZE_64KB) && !defined(CONFIG_MMU))
...
#undef CONFIG_MAX_ACTIVE_REGIONS
#if (defined(CONFIG_CPU_SUBTYPE_SHX3) && defined(CONFIG_SPARSEMEM))
  #define CONFIG_MAX_ACTIVE_REGIONS 6
#endif
#if (defined(CONFIG_SPARSEMEM) && (defined(CONFIG_CPU_SUBTYPE_SH7722) || defined(CONFIG_CPU_SUBTYPE_SH7785)) && (!defined(CONFIG_CPU_SUBTYPE_SHX3) || !defined(CONFIG_SPARSEMEM)))
  #define CONFIG_MAX_ACTIVE_REGIONS 2
#endif
#if ((!defined(CONFIG_SPARSEMEM) || (!defined(CONFIG_CPU_SUBTYPE_SH7722) && !defined(CONFIG_CPU_SUBTYPE_SH7785))) && (!defined(CONFIG_CPU_SUBTYPE_SHX3) || !defined(CONFIG_SPARSEMEM)))
...
#if (defined(CONFIG_NEED_MULTIPLE_NODES) && defined(CONFIG_CPU_SUBTYPE_SHX3))
...
#if (defined(CONFIG_SMP) && defined(CONFIG_CPU_SUBTYPE_SHX3))
...
#undef CONFIG_NR_DMA_CHANNELS
#if (defined(CONFIG_SH_DMA) && (defined(CONFIG_CPU_SUBTYPE_SH7750) || defined(CONFIG_CPU_SUBTYPE_SH7751) || defined(CONFIG_CPU_SUBTYPE_SH7750S) || defined(CONFIG_CPU_SUBTYPE_SH7091)) && defined(CONFIG_NR_DMA_CHANNELS_BOOL))
  #define CONFIG_NR_DMA_CHANNELS 4
#endif
#if (defined(CONFIG_SH_DMA) && (defined(CONFIG_CPU_SUBTYPE_SH7750R) || defined(CONFIG_CPU_SUBTYPE_SH7751R) || defined(CONFIG_CPU_SUBTYPE_SH7760)) && defined(CONFIG_NR_DMA_CHANNELS_BOOL) && (!defined(CONFIG_SH_DMA) || (!defined(CONFIG_CPU_SUBTYPE_SH7750) && !defined(CONFIG_CPU_SUBTYPE_SH7751) && !defined(CONFIG_CPU_SUBTYPE_SH7750S) && !defined(CONFIG_CPU_SUBTYPE_SH7091)) || !defined(CONFIG_NR_DMA_CHANNELS_BOOL)))
  #define CONFIG_NR_DMA_CHANNELS 8
#endif
#if ((!defined(CONFIG_SH_DMA) || (!defined(CONFIG_CPU_SUBTYPE_SH7750R) && !defined(CONFIG_CPU_SUBTYPE_SH7751R) && !defined(CONFIG_CPU_SUBTYPE_SH7760)) || !defined(CONFIG_NR_DMA_CHANNELS_BOOL)) && (defined(CONFIG_CPU_SUBTYPE_SH7723) || defined(CONFIG_CPU_SUBTYPE_SH7780) || defined(CONFIG_CPU_SUBTYPE_SH7785) || defined(CONFIG_CPU_SUBTYPE_SH7724)) && (!defined(CONFIG_SH_DMA) || (!defined(CONFIG_CPU_SUBTYPE_SH7750) && !defined(CONFIG_CPU_SUBTYPE_SH7751) && !defined(CONFIG_CPU_SUBTYPE_SH7750S) && !defined(CONFIG_CPU_SUBTYPE_SH7091)) || !defined(CONFIG_NR_DMA_CHANNELS_BOOL)) && defined(CONFIG_SH_DMA) && defined(CONFIG_NR_DMA_CHANNELS_BOOL))
  #define CONFIG_NR_DMA_CHANNELS 12
#endif
#if ((!defined(CONFIG_SH_DMA) || (!defined(CONFIG_CPU_SUBTYPE_SH7750R) && !defined(CONFIG_CPU_SUBTYPE_SH7751R) && !defined(CONFIG_CPU_SUBTYPE_SH7760)) || !defined(CONFIG_NR_DMA_CHANNELS_BOOL)) && (!defined(CONFIG_SH_DMA) || (!defined(CONFIG_CPU_SUBTYPE_SH7750) && !defined(CONFIG_CPU_SUBTYPE_SH7751) && !defined(CONFIG_CPU_SUBTYPE_SH7750S) && !defined(CONFIG_CPU_SUBTYPE_SH7091)) || !defined(CONFIG_NR_DMA_CHANNELS_BOOL)) && defined(CONFIG_SH_DMA) && defined(CONFIG_NR_DMA_CHANNELS_BOOL) && (!defined(CONFIG_SH_DMA) || (!defined(CONFIG_CPU_SUBTYPE_SH7723) && !defined(CONFIG_CPU_SUBTYPE_SH7780) && !defined(CONFIG_CPU_SUBTYPE_SH7785) && !defined(CONFIG_CPU_SUBTYPE_SH7724)) || !defined(CONFIG_NR_DMA_CHANNELS_BOOL)))
  #define CONFIG_NR_DMA_CHANNELS 6
#endif

#undef CONFIG_NR_ONCHIP_DMA_CHANNELS
#if (defined(CONFIG_SH_DMA) && (defined(CONFIG_CPU_SUBTYPE_SH7750) || defined(CONFIG_CPU_SUBTYPE_SH7751) || defined(CONFIG_CPU_SUBTYPE_SH7750S) || defined(CONFIG_CPU_SUBTYPE_SH7091)))
  #define CONFIG_NR_ONCHIP_DMA_CHANNELS 4
#endif
#if (defined(CONFIG_SH_DMA) && (defined(CONFIG_CPU_SUBTYPE_SH7750R) || defined(CONFIG_CPU_SUBTYPE_SH7751R) || defined(CONFIG_CPU_SUBTYPE_SH7760)) && (!defined(CONFIG_SH_DMA) || (!defined(CONFIG_CPU_SUBTYPE_SH7750) && !defined(CONFIG_CPU_SUBTYPE_SH7751) && !defined(CONFIG_CPU_SUBTYPE_SH7750S) && !defined(CONFIG_CPU_SUBTYPE_SH7091))))
  #define CONFIG_NR_ONCHIP_DMA_CHANNELS 8
#endif
#if (defined(CONFIG_SH_DMA) && (defined(CONFIG_CPU_SUBTYPE_SH7723) || defined(CONFIG_CPU_SUBTYPE_SH7780) || defined(CONFIG_CPU_SUBTYPE_SH7785) || defined(CONFIG_CPU_SUBTYPE_SH7724)) && (!defined(CONFIG_SH_DMA) || (!defined(CONFIG_CPU_SUBTYPE_SH7750R) && !defined(CONFIG_CPU_SUBTYPE_SH7751R) && !defined(CONFIG_CPU_SUBTYPE_SH7760))) && (!defined(CONFIG_SH_DMA) || (!defined(CONFIG_CPU_SUBTYPE_SH7750) && !defined(CONFIG_CPU_SUBTYPE_SH7751) && !defined(CONFIG_CPU_SUBTYPE_SH7750S) && !defined(CONFIG_CPU_SUBTYPE_SH7091))))
  #define CONFIG_NR_ONCHIP_DMA_CHANNELS 12
#endif
#if ((!defined(CONFIG_SH_DMA) || (!defined(CONFIG_CPU_SUBTYPE_SH7750R) && !defined(CONFIG_CPU_SUBTYPE_SH7751R) && !defined(CONFIG_CPU_SUBTYPE_SH7760))) && (!defined(CONFIG_SH_DMA) || (!defined(CONFIG_CPU_SUBTYPE_SH7750) && !defined(CONFIG_CPU_SUBTYPE_SH7751) && !defined(CONFIG_CPU_SUBTYPE_SH7750S) && !defined(CONFIG_CPU_SUBTYPE_SH7091))) && (!defined(CONFIG_SH_DMA) || (!defined(CONFIG_CPU_SUBTYPE_SH7723) && !defined(CONFIG_CPU_SUBTYPE_SH7780) && !defined(CONFIG_CPU_SUBTYPE_SH7785) && !defined(CONFIG_CPU_SUBTYPE_SH7724))) && defined(CONFIG_SH_DMA))
  #define CONFIG_NR_ONCHIP_DMA_CHANNELS 6
#endif

#undef CONFIG_NR_QUICK
#if (defined(CONFIG_QUICKLIST) && defined(CONFIG_SUPERH))
...
#if (defined(CONFIG_SUPERH32) && defined(CONFIG_MMU))
  #define CONFIG_PAGE_OFFSET 0x80000000
#endif
#if (defined(CONFIG_MMU) && defined(CONFIG_SUPERH64) && (!defined(CONFIG_SUPERH32) || !defined(CONFIG_MMU)))
  #define CONFIG_PAGE_OFFSET 0x20000000
#endif
#if ((!defined(CONFIG_MMU) || !defined(CONFIG_SUPERH64)) && (!defined(CONFIG_SUPERH32) || !defined(CONFIG_MMU)))
  #define CONFIG_PAGE_OFFSET 0x00000000
#endif
...
#undef CONFIG_SH_CLK_MD
#if (defined(CONFIG_CPU_SH2) && defined(CONFIG_CPU_SUBTYPE_SH7206))
  #define CONFIG_SH_CLK_MD 6
#endif
#if (defined(CONFIG_CPU_SH2) && defined(CONFIG_CPU_SUBTYPE_SH7619) && (!defined(CONFIG_CPU_SH2) || !defined(CONFIG_CPU_SUBTYPE_SH7206)))
  #define CONFIG_SH_CLK_MD 5
#endif
#if ((!defined(CONFIG_CPU_SH2) || !defined(CONFIG_CPU_SUBTYPE_SH7619)) && (!defined(CONFIG_CPU_SH2) || !defined(CONFIG_CPU_SUBTYPE_SH7206)) && defined(CONFIG_CPU_SH2))
  #define CONFIG_SH_CLK_MD 0
#endif

#define CONFIG_SH_MAGIC_PANEL_R2_VERSION 3

#undef CONFIG_SH_PCLK_FREQ
#if (defined(CONFIG_SH_CLK_CPG_LEGACY) && (defined(CONFIG_CPU_SUBTYPE_SH7760) || defined(CONFIG_CPU_SUBTYPE_MXG) || defined(CONFIG_CPU_SUBTYPE_SH7206) || defined(CONFIG_CPU_SUBTYPE_SH7705) || defined(CONFIG_CPU_SUBTYPE_SH7786) || defined(CONFIG_CPU_SUBTYPE_SH7770) || defined(CONFIG_CPU_SUBTYPE_SH7263) || defined(CONFIG_CPU_SUBTYPE_SH7203)) && (!defined(CONFIG_SH_CLK_CPG_LEGACY) || !defined(CONFIG_CPU_SUBTYPE_SH7619)))
  #define CONFIG_SH_PCLK_FREQ 33333333
#endif
#if ((!defined(CONFIG_SH_CLK_CPG_LEGACY) || !defined(CONFIG_CPU_SUBTYPE_SH7619)) && (!defined(CONFIG_SH_CLK_CPG_LEGACY) || (!defined(CONFIG_CPU_SUBTYPE_SH7751R) && !defined(CONFIG_CPU_SUBTYPE_SH7751))) && defined(CONFIG_SH_CLK_CPG_LEGACY) && (!defined(CONFIG_SH_CLK_CPG_LEGACY) || (!defined(CONFIG_CPU_SUBTYPE_SH7705) && !defined(CONFIG_CPU_SUBTYPE_SH7203) && !defined(CONFIG_CPU_SUBTYPE_SH7263) && !defined(CONFIG_CPU_SUBTYPE_SH7760) && !defined(CONFIG_CPU_SUBTYPE_SH7786) && !defined(CONFIG_CPU_SUBTYPE_MXG) && !defined(CONFIG_CPU_SUBTYPE_SH7770) && !defined(CONFIG_CPU_SUBTYPE_SH7206))) && (!defined(CONFIG_SH_CLK_CPG_LEGACY) || !defined(CONFIG_CPU_SUBTYPE_SH4_202)))
  #define CONFIG_SH_PCLK_FREQ 50000000
#endif
#if ((!defined(CONFIG_SH_CLK_CPG_LEGACY) || !defined(CONFIG_CPU_SUBTYPE_SH7619)) && (!defined(CONFIG_SH_CLK_CPG_LEGACY) || (!defined(CONFIG_CPU_SUBTYPE_SH7751R) && !defined(CONFIG_CPU_SUBTYPE_SH7751))) && defined(CONFIG_CPU_SUBTYPE_SH4_202) && defined(CONFIG_SH_CLK_CPG_LEGACY) && (!defined(CONFIG_SH_CLK_CPG_LEGACY) || (!defined(CONFIG_CPU_SUBTYPE_SH7705) && !defined(CONFIG_CPU_SUBTYPE_SH7203) && !defined(CONFIG_CPU_SUBTYPE_SH7263) && !defined(CONFIG_CPU_SUBTYPE_SH7760) && !defined(CONFIG_CPU_SUBTYPE_SH7786) && !defined(CONFIG_CPU_SUBTYPE_MXG) && !defined(CONFIG_CPU_SUBTYPE_SH7770) && !defined(CONFIG_CPU_SUBTYPE_SH7206))))
  #define CONFIG_SH_PCLK_FREQ 66000000
#endif
#if (defined(CONFIG_SH_CLK_CPG_LEGACY) && (defined(CONFIG_CPU_SUBTYPE_SH7751) || defined(CONFIG_CPU_SUBTYPE_SH7751R)) && (!defined(CONFIG_SH_CLK_CPG_LEGACY) || (!defined(CONFIG_CPU_SUBTYPE_SH7705) && !defined(CONFIG_CPU_SUBTYPE_SH7203) && !defined(CONFIG_CPU_SUBTYPE_SH7263) && !defined(CONFIG_CPU_SUBTYPE_SH7760) && !defined(CONFIG_CPU_SUBTYPE_SH7786) && !defined(CONFIG_CPU_SUBTYPE_MXG) && !defined(CONFIG_CPU_SUBTYPE_SH7770) && !defined(CONFIG_CPU_SUBTYPE_SH7206))) && (!defined(CONFIG_SH_CLK_CPG_LEGACY) || !defined(CONFIG_CPU_SUBTYPE_SH7619)))
  #define CONFIG_SH_PCLK_FREQ 60000000
#endif
#if (defined(CONFIG_SH_CLK_CPG_LEGACY) && defined(CONFIG_CPU_SUBTYPE_SH7619))
  #define CONFIG_SH_PCLK_FREQ 31250000
#endif
...
#undef CONFIG_ZERO_PAGE_OFFSET
#if (defined(CONFIG_PAGE_SIZE_64KB) || defined(CONFIG_SH_RTS7751R2D) || defined(CONFIG_SH_7751_SOLUTION_ENGINE))
  #define CONFIG_ZERO_PAGE_OFFSET 0x00010000
#endif
#if (!defined(CONFIG_PAGE_SIZE_64KB) && !defined(CONFIG_SH_RTS7751R2D) && !defined(CONFIG_SH_7751_SOLUTION_ENGINE) && (defined(CONFIG_PAGE_SIZE_16KB) || defined(CONFIG_SH_SH03)))
  #define CONFIG_ZERO_PAGE_OFFSET 0x00004000
#endif
#if (!defined(CONFIG_PAGE_SIZE_64KB) && !defined(CONFIG_SH_SH03) && !defined(CONFIG_SH_7751_SOLUTION_ENGINE) && !defined(CONFIG_PAGE_SIZE_16KB) && !defined(CONFIG_SH_RTS7751R2D) && defined(CONFIG_PAGE_SIZE_8KB))
  #define CONFIG_ZERO_PAGE_OFFSET 0x00002000
#endif
#if (!defined(CONFIG_PAGE_SIZE_64KB) && !defined(CONFIG_SH_SH03) && !defined(CONFIG_SH_7751_SOLUTION_ENGINE) && !defined(CONFIG_PAGE_SIZE_16KB) && !defined(CONFIG_SH_RTS7751R2D) && !defined(CONFIG_PAGE_SIZE_8KB))
