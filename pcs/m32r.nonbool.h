...
#if ((defined(CONFIG_PLAT_M32700UT) && !defined(CONFIG_PLAT_MAPPI) && !defined(CONFIG_PLAT_MAPPI3) && !defined(CONFIG_PLAT_MAPPI2) && !defined(CONFIG_PLAT_USRV)) || defined(CONFIG_PLAT_MAPPI) || (!defined(CONFIG_PLAT_M32700UT) && !defined(CONFIG_PLAT_MAPPI) && !defined(CONFIG_PLAT_MAPPI3) && !defined(CONFIG_PLAT_MAPPI2) && !defined(CONFIG_PLAT_USRV) && defined(CONFIG_PLAT_OPSPUT)) || defined(CONFIG_PLAT_MAPPI3) || defined(CONFIG_PLAT_MAPPI2) || (!defined(CONFIG_PLAT_MAPPI2) && !defined(CONFIG_PLAT_MAPPI3) && !defined(CONFIG_PLAT_MAPPI) && defined(CONFIG_PLAT_USRV)))
...
#endif
#if (!defined(CONFIG_PLAT_MAPPI2) && !defined(CONFIG_PLAT_MAPPI3) && !defined(CONFIG_PLAT_MAPPI) && defined(CONFIG_PLAT_USRV))
