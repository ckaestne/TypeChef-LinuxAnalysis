...
#undef CONFIG_FORCE_MAX_ZONEORDER
  ...
  #define CONFIG_FORCE_MAX_ZONEORDER 17
#endif
#if !defined(CONFIG_HUGETLB_PAGE)
...
#undef CONFIG_HZ
#if (!defined(CONFIG_IA64_HP_SIM) && defined(CONFIG_HZ_100))
  #define CONFIG_HZ 100
#endif
#if ((defined(CONFIG_HZ_250) && !defined(CONFIG_IA64_HP_SIM) && !defined(CONFIG_HZ_100)) || (!defined(CONFIG_IA64_HP_SIM) && defined(CONFIG_HZ_250) && (defined(CONFIG_IA64_HP_SIM) || !defined(CONFIG_HZ_300)) && (defined(CONFIG_IA64_HP_SIM) || !defined(CONFIG_HZ_1000)) && !defined(CONFIG_HZ_100) && (!defined(CONFIG_HZ_250) || defined(CONFIG_IA64_HP_SIM)) && (defined(CONFIG_IA64_HP_SIM) || !defined(CONFIG_HZ_100))))
  #define CONFIG_HZ 250
#endif
#if defined(CONFIG_IA64_HP_SIM)
  #define CONFIG_HZ 32
#endif
#if ((!defined(CONFIG_IA64_HP_SIM) && defined(CONFIG_HZ_300) && !defined(CONFIG_HZ_100) && (!defined(CONFIG_HZ_250) || defined(CONFIG_IA64_HP_SIM))) || (defined(CONFIG_HZ_300) && !defined(CONFIG_IA64_HP_SIM) && (defined(CONFIG_IA64_HP_SIM) || !defined(CONFIG_HZ_300)) && (defined(CONFIG_IA64_HP_SIM) || !defined(CONFIG_HZ_1000)) && !defined(CONFIG_HZ_100) && (!defined(CONFIG_HZ_250) || defined(CONFIG_IA64_HP_SIM)) && (defined(CONFIG_IA64_HP_SIM) || !defined(CONFIG_HZ_100))))
  #define CONFIG_HZ 300
#endif
#if ((!defined(CONFIG_IA64_HP_SIM) && (defined(CONFIG_IA64_HP_SIM) || !defined(CONFIG_HZ_300)) && defined(CONFIG_HZ_1000) && !defined(CONFIG_HZ_100) && (!defined(CONFIG_HZ_250) || defined(CONFIG_IA64_HP_SIM))) || (!defined(CONFIG_IA64_HP_SIM) && (defined(CONFIG_IA64_HP_SIM) || !defined(CONFIG_HZ_300)) && defined(CONFIG_HZ_1000) && (defined(CONFIG_IA64_HP_SIM) || !defined(CONFIG_HZ_1000)) && !defined(CONFIG_HZ_100) && (!defined(CONFIG_HZ_250) || defined(CONFIG_IA64_HP_SIM)) && (defined(CONFIG_IA64_HP_SIM) || !defined(CONFIG_HZ_100))))
  #define CONFIG_HZ 1000
#endif

#define CONFIG_I2C_BLACKFIN_TWI_CLK_KHZ 50

#undef CONFIG_IA64_L1_CACHE_SHIFT
#if defined(CONFIG_MCKINLEY)
  #define CONFIG_IA64_L1_CACHE_SHIFT 7
#endif
#if (defined(CONFIG_ITANIUM) && !defined(CONFIG_MCKINLEY))
  #define CONFIG_IA64_L1_CACHE_SHIFT 6
#endif
