...
#undef CONFIG_BUS_CLOCK
#if (!defined(CONFIG_PLAT_M32700UT) && !defined(CONFIG_PLAT_MAPPI) && !defined(CONFIG_PLAT_MAPPI3) && !defined(CONFIG_PLAT_M32104UT) && defined(CONFIG_PLAT_OAKS32R) && !defined(CONFIG_PLAT_USRV) && !defined(CONFIG_PLAT_OPSPUT))
  #define CONFIG_BUS_CLOCK 33333333
#endif
#if ((!defined(CONFIG_PLAT_USRV) && !defined(CONFIG_PLAT_MAPPI) && defined(CONFIG_PLAT_MAPPI3)) || (!defined(CONFIG_PLAT_USRV) && !defined(CONFIG_PLAT_MAPPI) && !defined(CONFIG_PLAT_MAPPI3) && defined(CONFIG_PLAT_M32700UT)) || (!defined(CONFIG_PLAT_M32700UT) && !defined(CONFIG_PLAT_MAPPI) && !defined(CONFIG_PLAT_MAPPI3) && !defined(CONFIG_PLAT_USRV) && defined(CONFIG_PLAT_OPSPUT)))
  #define CONFIG_BUS_CLOCK 50000000
#endif
#if (!defined(CONFIG_PLAT_M32700UT) && !defined(CONFIG_PLAT_MAPPI) && defined(CONFIG_PLAT_MAPPI2) && !defined(CONFIG_PLAT_OAKS32R) && !defined(CONFIG_PLAT_MAPPI3) && !defined(CONFIG_PLAT_M32104UT) && !defined(CONFIG_PLAT_USRV) && !defined(CONFIG_PLAT_OPSPUT))
  #define CONFIG_BUS_CLOCK 20000000
#endif
#if (defined(CONFIG_PLAT_USRV) && !defined(CONFIG_PLAT_MAPPI))
  #define CONFIG_BUS_CLOCK 25000000
#endif
#if defined(CONFIG_PLAT_MAPPI)
  #define CONFIG_BUS_CLOCK 70000000
#endif
#if (!defined(CONFIG_PLAT_M32700UT) && defined(CONFIG_PLAT_M32104UT) && !defined(CONFIG_PLAT_MAPPI) && !defined(CONFIG_PLAT_MAPPI3) && !defined(CONFIG_PLAT_USRV) && !defined(CONFIG_PLAT_OPSPUT))
  #define CONFIG_BUS_CLOCK 54000000
#endif
...
#undef CONFIG_IRAM_SIZE
#if (defined(CONFIG_DISCONTIGMEM) && defined(CONFIG_CHIP_M32700) && (defined(CONFIG_CHIP_M32104) || defined(CONFIG_CHIP_VDEC2) || defined(CONFIG_CHIP_OPSP) || defined(CONFIG_CHIP_M32700) || defined(CONFIG_CHIP_M32102)))
  #define CONFIG_IRAM_SIZE 00080000
#endif
#if (defined(CONFIG_DISCONTIGMEM) && (defined(CONFIG_CHIP_OPSP) || defined(CONFIG_CHIP_M32104) || defined(CONFIG_CHIP_M32102)) && (defined(CONFIG_CHIP_M32104) || defined(CONFIG_CHIP_VDEC2) || defined(CONFIG_CHIP_OPSP) || defined(CONFIG_CHIP_M32700) || defined(CONFIG_CHIP_M32102)) && (!defined(CONFIG_DISCONTIGMEM) || !defined(CONFIG_CHIP_M32700) || (!defined(CONFIG_CHIP_OPSP) && !defined(CONFIG_CHIP_M32104) && !defined(CONFIG_CHIP_M32102) && !defined(CONFIG_CHIP_VDEC2) && !defined(CONFIG_CHIP_M32700))))
  #define CONFIG_IRAM_SIZE 00010000
#endif
#if ((defined(CONFIG_CHIP_M32104) || defined(CONFIG_CHIP_VDEC2) || defined(CONFIG_CHIP_OPSP) || defined(CONFIG_CHIP_M32700) || defined(CONFIG_CHIP_M32102)) && (!defined(CONFIG_DISCONTIGMEM) || (!defined(CONFIG_CHIP_OPSP) && !defined(CONFIG_CHIP_M32104) && !defined(CONFIG_CHIP_M32102)) || (!defined(CONFIG_CHIP_OPSP) && !defined(CONFIG_CHIP_M32104) && !defined(CONFIG_CHIP_M32102) && !defined(CONFIG_CHIP_VDEC2) && !defined(CONFIG_CHIP_M32700))) && (!defined(CONFIG_DISCONTIGMEM) || !defined(CONFIG_CHIP_M32700) || (!defined(CONFIG_CHIP_OPSP) && !defined(CONFIG_CHIP_M32104) && !defined(CONFIG_CHIP_M32102) && !defined(CONFIG_CHIP_VDEC2) && !defined(CONFIG_CHIP_M32700))) && defined(CONFIG_CHIP_VDEC2) && defined(CONFIG_DISCONTIGMEM))
  #define CONFIG_IRAM_SIZE 00008000
#endif

#undef CONFIG_IRAM_START
#if (defined(CONFIG_DISCONTIGMEM) && !defined(CONFIG_CHIP_M32104) && (defined(CONFIG_CHIP_M32104) || defined(CONFIG_CHIP_VDEC2) || defined(CONFIG_CHIP_OPSP) || defined(CONFIG_CHIP_M32700) || defined(CONFIG_CHIP_M32102)))
  #define CONFIG_IRAM_START 00f00000
#endif
#if (defined(CONFIG_DISCONTIGMEM) && defined(CONFIG_CHIP_M32104) && (defined(CONFIG_CHIP_M32104) || defined(CONFIG_CHIP_VDEC2) || defined(CONFIG_CHIP_OPSP) || defined(CONFIG_CHIP_M32700) || defined(CONFIG_CHIP_M32102)) && (!defined(CONFIG_DISCONTIGMEM) || defined(CONFIG_CHIP_M32104) || (!defined(CONFIG_CHIP_OPSP) && !defined(CONFIG_CHIP_M32104) && !defined(CONFIG_CHIP_M32102) && !defined(CONFIG_CHIP_VDEC2) && !defined(CONFIG_CHIP_M32700))))
  #define CONFIG_IRAM_START 00700000
#endif
...
#undef CONFIG_MEMORY_SIZE
#if defined(CONFIG_PLAT_MAPPI3)
  #define CONFIG_MEMORY_SIZE 08000000
#endif
#if (!defined(CONFIG_PLAT_M32700UT) && !defined(CONFIG_PLAT_MAPPI) && !defined(CONFIG_PLAT_MAPPI3) && !defined(CONFIG_PLAT_M32104UT) && defined(CONFIG_PLAT_OAKS32R) && !defined(CONFIG_PLAT_MAPPI2) && !defined(CONFIG_PLAT_USRV) && !defined(CONFIG_PLAT_OPSPUT))
  #define CONFIG_MEMORY_SIZE 00800000
#endif
#if ((defined(CONFIG_PLAT_M32700UT) && !defined(CONFIG_PLAT_MAPPI) && !defined(CONFIG_PLAT_MAPPI3) && !defined(CONFIG_PLAT_MAPPI2) && !defined(CONFIG_PLAT_USRV)) || (!defined(CONFIG_PLAT_M32700UT) && !defined(CONFIG_PLAT_MAPPI) && !defined(CONFIG_PLAT_MAPPI3) && !defined(CONFIG_PLAT_MAPPI2) && !defined(CONFIG_PLAT_USRV) && defined(CONFIG_PLAT_OPSPUT)) || (!defined(CONFIG_PLAT_M32700UT) && defined(CONFIG_PLAT_M32104UT) && !defined(CONFIG_PLAT_MAPPI) && !defined(CONFIG_PLAT_MAPPI3) && !defined(CONFIG_PLAT_MAPPI2) && !defined(CONFIG_PLAT_USRV) && !defined(CONFIG_PLAT_OPSPUT)))
  #define CONFIG_MEMORY_SIZE 01000000
#endif
#if (!defined(CONFIG_PLAT_MAPPI3) && (defined(CONFIG_PLAT_MAPPI) || defined(CONFIG_PLAT_MAPPI2)))
  #define CONFIG_MEMORY_SIZE 04000000
#endif
#if (!defined(CONFIG_PLAT_MAPPI) && !defined(CONFIG_PLAT_MAPPI2) && !defined(CONFIG_PLAT_MAPPI3) && defined(CONFIG_PLAT_USRV))
  #define CONFIG_MEMORY_SIZE 02000000
#endif

#undef CONFIG_MEMORY_START
#if ((defined(CONFIG_PLAT_M32700UT) && !defined(CONFIG_PLAT_MAPPI) && !defined(CONFIG_PLAT_MAPPI3) && !defined(CONFIG_PLAT_MAPPI2) && !defined(CONFIG_PLAT_USRV)) || (!defined(CONFIG_PLAT_MAPPI) && !defined(CONFIG_PLAT_MAPPI2) && !defined(CONFIG_PLAT_MAPPI3) && defined(CONFIG_PLAT_USRV)) || defined(CONFIG_PLAT_MAPPI) || (!defined(CONFIG_PLAT_M32700UT) && !defined(CONFIG_PLAT_MAPPI) && !defined(CONFIG_PLAT_MAPPI3) && !defined(CONFIG_PLAT_MAPPI2) && !defined(CONFIG_PLAT_USRV) && defined(CONFIG_PLAT_OPSPUT)) || defined(CONFIG_PLAT_MAPPI3) || defined(CONFIG_PLAT_MAPPI2))
  #define CONFIG_MEMORY_START 08000000
#endif
#if (!defined(CONFIG_PLAT_M32700UT) && defined(CONFIG_PLAT_M32104UT) && !defined(CONFIG_PLAT_MAPPI) && !defined(CONFIG_PLAT_MAPPI3) && !defined(CONFIG_PLAT_MAPPI2) && !defined(CONFIG_PLAT_USRV) && !defined(CONFIG_PLAT_OPSPUT))
  #define CONFIG_MEMORY_START 04000000
#endif
#if (!defined(CONFIG_PLAT_M32700UT) && !defined(CONFIG_PLAT_MAPPI) && !defined(CONFIG_PLAT_MAPPI3) && !defined(CONFIG_PLAT_M32104UT) && defined(CONFIG_PLAT_OAKS32R) && !defined(CONFIG_PLAT_MAPPI2) && !defined(CONFIG_PLAT_USRV) && !defined(CONFIG_PLAT_OPSPUT))
  #define CONFIG_MEMORY_START 01000000
#endif
...
#undef CONFIG_TLB_ENTRIES
#if ((defined(CONFIG_CHIP_M32700) || defined(CONFIG_CHIP_OPSP)) && (defined(CONFIG_CHIP_VDEC2) || defined(CONFIG_CHIP_OPSP) || defined(CONFIG_CHIP_M32700)))
  #define CONFIG_TLB_ENTRIES 32
#endif
#if (defined(CONFIG_CHIP_VDEC2) && ((!defined(CONFIG_CHIP_M32700) && !defined(CONFIG_CHIP_OPSP)) || (!defined(CONFIG_CHIP_VDEC2) && !defined(CONFIG_CHIP_OPSP) && !defined(CONFIG_CHIP_M32700))))
  #define CONFIG_TLB_ENTRIES 16
#endif
