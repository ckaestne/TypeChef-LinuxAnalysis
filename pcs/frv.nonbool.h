...
#undef CONFIG_FRV_L1_CACHE_SHIFT
#if (defined(CONFIG_CPU_FR401) || defined(CONFIG_CPU_FR405) || defined(CONFIG_CPU_FR451))
  #define CONFIG_FRV_L1_CACHE_SHIFT 5
#endif
#if (!defined(CONFIG_CPU_FR401) && !defined(CONFIG_CPU_FR405) && !defined(CONFIG_CPU_FR451) && defined(CONFIG_CPU_FR551))
  #define CONFIG_FRV_L1_CACHE_SHIFT 6
#endif
...
#if (!defined(CONFIG_UCPAGE_OFFSET_40000000) && !defined(CONFIG_UCPAGE_OFFSET_20000000) && !defined(CONFIG_UCPAGE_OFFSET_60000000) && !defined(CONFIG_UCPAGE_OFFSET_A0000000) && !defined(CONFIG_UCPAGE_OFFSET_80000000))
  #define CONFIG_PAGE_OFFSET 0xC0000000
#endif
#if (!defined(CONFIG_UCPAGE_OFFSET_20000000) && !defined(CONFIG_UCPAGE_OFFSET_40000000) && !defined(CONFIG_UCPAGE_OFFSET_60000000) && defined(CONFIG_UCPAGE_OFFSET_80000000))
  #define CONFIG_PAGE_OFFSET 0x80000000
#endif
#if defined(CONFIG_UCPAGE_OFFSET_20000000)
  #define CONFIG_PAGE_OFFSET 0x20000000
#endif
#if (!defined(CONFIG_UCPAGE_OFFSET_40000000) && !defined(CONFIG_UCPAGE_OFFSET_20000000) && !defined(CONFIG_UCPAGE_OFFSET_60000000) && !defined(CONFIG_UCPAGE_OFFSET_80000000) && defined(CONFIG_UCPAGE_OFFSET_A0000000))
  #define CONFIG_PAGE_OFFSET 0xA0000000
#endif
#if (!defined(CONFIG_UCPAGE_OFFSET_20000000) && !defined(CONFIG_UCPAGE_OFFSET_40000000) && defined(CONFIG_UCPAGE_OFFSET_60000000))
  #define CONFIG_PAGE_OFFSET 0x60000000
#endif
#if (defined(CONFIG_UCPAGE_OFFSET_40000000) && !defined(CONFIG_UCPAGE_OFFSET_20000000))
