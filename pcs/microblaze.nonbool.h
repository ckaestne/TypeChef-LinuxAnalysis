...
#define CONFIG_CMDLINE "console=ttyUL0,115200"

//WARNING: no defaults for CONFIG_CONSISTENT_SIZE
#define CONFIG_CONSISTENT_SIZE 0

//WARNING: no defaults for CONFIG_CONSISTENT_START
#define CONFIG_CONSISTENT_START 0
...
#define CONFIG_KERNEL_BASE_ADDR 0x90000000

#undef CONFIG_KERNEL_START
#if defined(CONFIG_MMU)
  #define CONFIG_KERNEL_START 0xc0000000
#endif
#if (defined(CONFIG_PLATFORM_GENERIC) && !defined(CONFIG_MMU))
  #define CONFIG_KERNEL_START 0x90000000
#endif
...
#define CONFIG_XILINX_MICROBLAZE0_FAMILY "virtex5"

#define CONFIG_XILINX_MICROBLAZE0_HW_VER "7.10.d"

#define CONFIG_XILINX_MICROBLAZE0_USE_BARREL 0

#define CONFIG_XILINX_MICROBLAZE0_USE_DIV 0

#define CONFIG_XILINX_MICROBLAZE0_USE_FPU 0

#define CONFIG_XILINX_MICROBLAZE0_USE_HW_MUL 0

#define CONFIG_XILINX_MICROBLAZE0_USE_MSR_INSTR 0

#define CONFIG_XILINX_MICROBLAZE0_USE_PCMP_INSTR 0
