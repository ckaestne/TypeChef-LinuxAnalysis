...
#define CONFIG_BOOTPARAM_STRING "console=ttyS0,19200"

#define CONFIG_CDROM_PKTCDVD_BUFFERS 8

#define CONFIG_CFAG12864B_RATE 20

#define CONFIG_CLOCK_DIV 1

#define CONFIG_CLOCK_FREQ 66666666
...
#define CONFIG_KERNELBASE 0x400
...
//WARNING: no defaults for CONFIG_MEMORY_RESERVE
...
#define CONFIG_RAMSIZE 0x400000
...
#define CONFIG_ROMBASE 0

#define CONFIG_ROMSIZE 0x100000

#define CONFIG_ROMSTART 0x400

#define CONFIG_ROMVEC 0

#define CONFIG_ROMVECSIZE 0x400
