...
#if ((defined(CONFIG_ETRAX_ARCH_V10) && defined(CONFIG_ETRAX_GPIO)) || ((!defined(CONFIG_ETRAX_GPIO) || defined(CONFIG_ETRAXFS) || !defined(CONFIG_ETRAX_ARCH_V32)) && (!defined(CONFIG_ETRAX_GPIO) || !defined(CONFIG_ETRAXFS) || !defined(CONFIG_ETRAX_ARCH_V32)) && defined(CONFIG_ETRAX_GPIO) && defined(CONFIG_ETRAX_ARCH_V10)))
