...
#define CONFIG_BOOTLOADER_FAMILY "85"
...
#define CONFIG_CAVIUM_OCTEON_CVMSEG_SIZE 1
...
#undef CONFIG_HZ
#if (defined(CONFIG_HZ_100) && !defined(CONFIG_HZ_48))
  #define CONFIG_HZ 100
#endif
#if (!defined(CONFIG_HZ_48) && !defined(CONFIG_HZ_100) && defined(CONFIG_HZ_128))
  #define CONFIG_HZ 128
#endif
#if (!defined(CONFIG_HZ_48) && !defined(CONFIG_HZ_100) && !defined(CONFIG_HZ_128) && defined(CONFIG_HZ_250))
  #define CONFIG_HZ 250
#endif
#if (!defined(CONFIG_HZ_128) && !defined(CONFIG_HZ_100) && !defined(CONFIG_HZ_250) && !defined(CONFIG_HZ_48) && defined(CONFIG_HZ_256))
  #define CONFIG_HZ 256
#endif
#if defined(CONFIG_HZ_48)
  #define CONFIG_HZ 48
#endif
#if (!defined(CONFIG_HZ_128) && !defined(CONFIG_HZ_1000) && !defined(CONFIG_HZ_100) && defined(CONFIG_HZ_1024) && !defined(CONFIG_HZ_250) && !defined(CONFIG_HZ_256) && !defined(CONFIG_HZ_48))
  #define CONFIG_HZ 1024
#endif
#if (!defined(CONFIG_HZ_128) && defined(CONFIG_HZ_1000) && !defined(CONFIG_HZ_100) && !defined(CONFIG_HZ_250) && !defined(CONFIG_HZ_256) && !defined(CONFIG_HZ_48))
...
#undef CONFIG_MIPS_L1_CACHE_SHIFT
#if (defined(CONFIG_MACH_DECSTATION) || defined(CONFIG_MIKROTIK_RB532) || defined(CONFIG_PMC_MSP4200_EVAL))
  #define CONFIG_MIPS_L1_CACHE_SHIFT 4
#endif
#if (!defined(CONFIG_MACH_DECSTATION) && !defined(CONFIG_MIKROTIK_RB532) && !defined(CONFIG_PMC_MSP4200_EVAL) && defined(CONFIG_MIPS_CPU_SCACHE))
  #define CONFIG_MIPS_L1_CACHE_SHIFT 6
#endif
#if (!defined(CONFIG_PMC_MSP4200_EVAL) && (defined(CONFIG_SGI_IP28) || defined(CONFIG_SNI_RM) || defined(CONFIG_CPU_CAVIUM_OCTEON) || defined(CONFIG_SGI_IP22) || defined(CONFIG_SGI_IP27)) && !defined(CONFIG_MACH_DECSTATION) && !defined(CONFIG_MIPS_CPU_SCACHE) && !defined(CONFIG_MIKROTIK_RB532))
  #define CONFIG_MIPS_L1_CACHE_SHIFT 7
#endif
#if (!defined(CONFIG_SNI_RM) && !defined(CONFIG_SGI_IP27) && !defined(CONFIG_PMC_MSP4200_EVAL) && !defined(CONFIG_CPU_CAVIUM_OCTEON) && !defined(CONFIG_MACH_DECSTATION) && !defined(CONFIG_MIPS_CPU_SCACHE) && !defined(CONFIG_SGI_IP22) && !defined(CONFIG_MIKROTIK_RB532) && !defined(CONFIG_SGI_IP28))
...
#if (defined(CONFIG_NR_CPUS_DEFAULT_8) && (!defined(CONFIG_SMP) || !defined(CONFIG_NR_CPUS_DEFAULT_1)) && defined(CONFIG_SMP) && (!defined(CONFIG_SMP) || !defined(CONFIG_NR_CPUS_DEFAULT_4)) && (!defined(CONFIG_SMP) || !defined(CONFIG_NR_CPUS_DEFAULT_2)))
  #define CONFIG_NR_CPUS 8
#endif
#if (defined(CONFIG_SMP) && defined(CONFIG_NR_CPUS_DEFAULT_4) && (!defined(CONFIG_SMP) || !defined(CONFIG_NR_CPUS_DEFAULT_2)) && (!defined(CONFIG_SMP) || !defined(CONFIG_NR_CPUS_DEFAULT_1)))
  #define CONFIG_NR_CPUS 4
#endif
#if ((!defined(CONFIG_SMP) || !defined(CONFIG_NR_CPUS_DEFAULT_8)) && defined(CONFIG_NR_CPUS_DEFAULT_16) && (!defined(CONFIG_SMP) || !defined(CONFIG_NR_CPUS_DEFAULT_1)) && defined(CONFIG_SMP) && (!defined(CONFIG_SMP) || !defined(CONFIG_NR_CPUS_DEFAULT_4)) && (!defined(CONFIG_SMP) || !defined(CONFIG_NR_CPUS_DEFAULT_2)))
  #define CONFIG_NR_CPUS 16
#endif
#if ((!defined(CONFIG_SMP) || !defined(CONFIG_NR_CPUS_DEFAULT_16)) && (!defined(CONFIG_SMP) || !defined(CONFIG_NR_CPUS_DEFAULT_8)) && (!defined(CONFIG_SMP) || !defined(CONFIG_NR_CPUS_DEFAULT_1)) && defined(CONFIG_NR_CPUS_DEFAULT_32) && defined(CONFIG_SMP) && (!defined(CONFIG_SMP) || !defined(CONFIG_NR_CPUS_DEFAULT_4)) && (!defined(CONFIG_SMP) || !defined(CONFIG_NR_CPUS_DEFAULT_2)))
  #define CONFIG_NR_CPUS 32
#endif
#if (defined(CONFIG_SMP) && defined(CONFIG_NR_CPUS_DEFAULT_1))
  #define CONFIG_NR_CPUS 1
#endif
#if (defined(CONFIG_NR_CPUS_DEFAULT_64) && (!defined(CONFIG_SMP) || !defined(CONFIG_NR_CPUS_DEFAULT_32)) && (!defined(CONFIG_SMP) || !defined(CONFIG_NR_CPUS_DEFAULT_16)) && (!defined(CONFIG_SMP) || !defined(CONFIG_NR_CPUS_DEFAULT_8)) && (!defined(CONFIG_SMP) || !defined(CONFIG_NR_CPUS_DEFAULT_1)) && defined(CONFIG_SMP) && (!defined(CONFIG_SMP) || !defined(CONFIG_NR_CPUS_DEFAULT_4)) && (!defined(CONFIG_SMP) || !defined(CONFIG_NR_CPUS_DEFAULT_2)))
  #define CONFIG_NR_CPUS 64
#endif
#if (defined(CONFIG_SMP) && defined(CONFIG_NR_CPUS_DEFAULT_2) && (!defined(CONFIG_SMP) || !defined(CONFIG_NR_CPUS_DEFAULT_1)))
