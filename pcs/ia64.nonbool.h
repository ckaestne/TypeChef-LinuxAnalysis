...
#endif
#if ((!defined(CONFIG_IA64_HP_SIM) && defined(CONFIG_HZ_250) && !defined(CONFIG_HZ_100)) || ((defined(CONFIG_IA64_HP_SIM) || !defined(CONFIG_HZ_250)) && !defined(CONFIG_IA64_HP_SIM) && defined(CONFIG_HZ_250) && (defined(CONFIG_IA64_HP_SIM) || !defined(CONFIG_HZ_300)) && (defined(CONFIG_IA64_HP_SIM) || !defined(CONFIG_HZ_1000)) && !defined(CONFIG_HZ_100) && (defined(CONFIG_IA64_HP_SIM) || !defined(CONFIG_HZ_100))))
  #define CONFIG_HZ 250
#endif
#if defined(CONFIG_IA64_HP_SIM)
  #define CONFIG_HZ 32
#endif
#if ((!defined(CONFIG_IA64_HP_SIM) && defined(CONFIG_HZ_300) && !defined(CONFIG_HZ_100) && (defined(CONFIG_IA64_HP_SIM) || !defined(CONFIG_HZ_250))) || (defined(CONFIG_HZ_300) && (defined(CONFIG_IA64_HP_SIM) || !defined(CONFIG_HZ_250)) && !defined(CONFIG_IA64_HP_SIM) && (defined(CONFIG_IA64_HP_SIM) || !defined(CONFIG_HZ_300)) && (defined(CONFIG_IA64_HP_SIM) || !defined(CONFIG_HZ_1000)) && !defined(CONFIG_HZ_100) && (defined(CONFIG_IA64_HP_SIM) || !defined(CONFIG_HZ_100))))
  #define CONFIG_HZ 300
#endif
#if ((defined(CONFIG_IA64_HP_SIM) || !defined(CONFIG_HZ_250)) && !defined(CONFIG_IA64_HP_SIM) && (defined(CONFIG_IA64_HP_SIM) || !defined(CONFIG_HZ_300)) && defined(CONFIG_HZ_1000) && !defined(CONFIG_HZ_100))
