...
#undef CONFIG_KERNEL_START
  ...
  #define CONFIG_KERNEL_START PAGE_OFFSET
#endif
#if (defined(CONFIG_PPC32) && defined(CONFIG_CRASH_DUMP) && (!defined(CONFIG_PPC32) || !defined(CONFIG_PAGE_OFFSET_BOOL)))
  #define CONFIG_KERNEL_START 0xc2000000
#endif
#if ((!defined(CONFIG_PPC32) || !defined(CONFIG_CRASH_DUMP)) && (!defined(CONFIG_PPC32) || !defined(CONFIG_PAGE_OFFSET_BOOL)) && defined(CONFIG_PPC32))
  #define CONFIG_KERNEL_START 0xc0000000
#endif
#if ((!defined(CONFIG_PPC32) || !defined(CONFIG_CRASH_DUMP)) && (!defined(CONFIG_PPC32) || !defined(CONFIG_PAGE_OFFSET_BOOL)) && !defined(CONFIG_PPC32) && defined(CONFIG_PPC64))
