...
#endif
#if (defined(CONFIG_SMP) && defined(CONFIG_64BIT) && (!defined(CONFIG_SMP) || defined(CONFIG_64BIT)))
...
//WARNING: no defaults for CONFIG_SCSI_MPT2SAS_MAX_SGE
#define CONFIG_SCSI_MPT2SAS_MAX_SGE 0
...
#define CONFIG_WARN_STACK_SIZE 2048
