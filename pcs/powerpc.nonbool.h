...
//WARNING: no defaults for CONFIG_EXTRA_TARGETS
...
#if (!defined(CONFIG_PPC64) && (!defined(CONFIG_PPC32) || !defined(CONFIG_PPC_16K_PAGES)) && (!defined(CONFIG_PPC32) || !defined(CONFIG_PPC_64K_PAGES)) && (!defined(CONFIG_PPC32) || !defined(CONFIG_PPC_256K_PAGES)))
  #define CONFIG_FORCE_MAX_ZONEORDER 11
#endif
#if ((defined(CONFIG_PPC64) && defined(CONFIG_PPC_64K_PAGES)) || (defined(CONFIG_PPC32) && defined(CONFIG_PPC_16K_PAGES) && !defined(CONFIG_PPC64)))
  #define CONFIG_FORCE_MAX_ZONEORDER 9
#endif
#if (defined(CONFIG_PPC64) && !defined(CONFIG_PPC_64K_PAGES) && (!defined(CONFIG_PPC64) || !defined(CONFIG_PPC_64K_PAGES)))
  #define CONFIG_FORCE_MAX_ZONEORDER 13
#endif
#if (!defined(CONFIG_PPC64) && (!defined(CONFIG_PPC32) || !defined(CONFIG_PPC_16K_PAGES)) && defined(CONFIG_PPC_256K_PAGES) && (!defined(CONFIG_PPC32) || !defined(CONFIG_PPC_64K_PAGES)) && defined(CONFIG_PPC32))
  #define CONFIG_FORCE_MAX_ZONEORDER 5
#endif
#if (defined(CONFIG_PPC32) && defined(CONFIG_PPC_64K_PAGES) && !defined(CONFIG_PPC64) && (!defined(CONFIG_PPC32) || !defined(CONFIG_PPC_16K_PAGES)))
...
#undef CONFIG_KERNEL_START
#if ((defined(CONFIG_PPC32) && defined(CONFIG_PAGE_OFFSET_BOOL)) || (defined(CONFIG_PPC32) && defined(CONFIG_PAGE_OFFSET_BOOL) && (!defined(CONFIG_PPC32) || !defined(CONFIG_PAGE_OFFSET_BOOL) || !defined(CONFIG_PPC64))) || ((!defined(CONFIG_PPC32) || !defined(CONFIG_PAGE_OFFSET_BOOL) || !defined(CONFIG_PPC64)) && (!defined(CONFIG_PPC32) || !defined(CONFIG_PAGE_OFFSET_BOOL)) && (!defined(CONFIG_PPC32) || !defined(CONFIG_CRASH_DUMP)) && defined(CONFIG_PPC32)))
  #define CONFIG_KERNEL_START 0xc0000000
#endif
#if ((defined(CONFIG_PPC32) && defined(CONFIG_PAGE_OFFSET_BOOL) && defined(CONFIG_PPC64) && (!defined(CONFIG_PPC32) || !defined(CONFIG_PAGE_OFFSET_BOOL))) || ((!defined(CONFIG_PPC32) || !defined(CONFIG_PAGE_OFFSET_BOOL) || !defined(CONFIG_PPC64)) && (!defined(CONFIG_PPC32) || !defined(CONFIG_CRASH_DUMP)) && !defined(CONFIG_PPC32) && (!defined(CONFIG_PPC32) || !defined(CONFIG_PAGE_OFFSET_BOOL)) && defined(CONFIG_PPC64)))
  #define CONFIG_KERNEL_START 0xc000000000000000
#endif
#if (defined(CONFIG_PPC32) && defined(CONFIG_CRASH_DUMP) && (!defined(CONFIG_PPC32) || !defined(CONFIG_PAGE_OFFSET_BOOL) || !defined(CONFIG_PPC64)) && (!defined(CONFIG_PPC32) || !defined(CONFIG_PAGE_OFFSET_BOOL)))
  #define CONFIG_KERNEL_START 0xc2000000
#endif
...
#undef CONFIG_MAX_ACTIVE_REGIONS
  ...
  #define CONFIG_MAX_ACTIVE_REGIONS 256
#endif
#if !defined(CONFIG_PPC64)
...
#if (defined(CONFIG_NEED_MULTIPLE_NODES) && defined(CONFIG_PPC64))
...
#undef CONFIG_PHYSICAL_START
#if (defined(CONFIG_PPC_STD_MMU) && defined(CONFIG_CRASH_DUMP) && defined(CONFIG_PPC32))
  #define CONFIG_PHYSICAL_START 0x02000000
#endif
#if ((defined(CONFIG_PPC32) && (!defined(CONFIG_PPC_STD_MMU) || !defined(CONFIG_CRASH_DUMP))) || (defined(CONFIG_PPC64) && !defined(CONFIG_PPC32)))
  #define CONFIG_PHYSICAL_START 0x00000000
#endif

#define CONFIG_PM_STD_PARTITION ""

#define CONFIG_PPC_EARLY_DEBUG_40x_PHYSADDR 0xef600300

#define CONFIG_PPC_EARLY_DEBUG_44x_PHYSHIGH 0x1

#define CONFIG_PPC_EARLY_DEBUG_44x_PHYSLOW 0x40000200

#undef CONFIG_PPC_EARLY_DEBUG_CPM_ADDR
#if (defined(CONFIG_PPC_EARLY_DEBUG_CPM) && defined(CONFIG_PPC_EP88XC))
  #define CONFIG_PPC_EARLY_DEBUG_CPM_ADDR 0xfa202008
#endif
#if (defined(CONFIG_PPC_EARLY_DEBUG_CPM) && defined(CONFIG_CPM2) && (!defined(CONFIG_PPC_EARLY_DEBUG_CPM) || !defined(CONFIG_PPC_EP88XC)))
  #define CONFIG_PPC_EARLY_DEBUG_CPM_ADDR 0xf0001ff8
#endif
#if (defined(CONFIG_PPC_EARLY_DEBUG_CPM) && defined(CONFIG_CPM1) && (!defined(CONFIG_PPC_EARLY_DEBUG_CPM) || !defined(CONFIG_CPM2)) && (!defined(CONFIG_PPC_EARLY_DEBUG_CPM) || !defined(CONFIG_PPC_EP88XC)))
  #define CONFIG_PPC_EARLY_DEBUG_CPM_ADDR 0xff002008
#endif

#define CONFIG_PRINT_STACK_DEPTH 64

#define CONFIG_PS3_HTAB_SIZE 20
...
#undef CONFIG_TASK_SIZE
#if (defined(CONFIG_PPC32) && (defined(CONFIG_PPC_PREP) || defined(CONFIG_PPC_8xx)))
  #define CONFIG_TASK_SIZE 0x80000000
#endif
#if (!defined(CONFIG_PPC_PREP) && !defined(CONFIG_PPC_8xx) && defined(CONFIG_PPC32))
