...
#if (defined(CONFIG_SMP) && (defined(CONFIG_ALPHA_GENERIC) || defined(CONFIG_ALPHA_MARVEL)))
  #define CONFIG_NR_CPUS 32
#endif
#if (!defined(CONFIG_ALPHA_GENERIC) && !defined(CONFIG_ALPHA_MARVEL) && defined(CONFIG_SMP) && (!defined(CONFIG_SMP) || (!defined(CONFIG_ALPHA_GENERIC) && !defined(CONFIG_ALPHA_MARVEL))))
