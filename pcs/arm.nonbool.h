...
//WARNING: no defaults for CONFIG_BCM_ZRELADDR
#define CONFIG_BCM_ZRELADDR 0
...
#if (defined(CONFIG_ARM) && defined(CONFIG_PLAT_S3C) && defined(CONFIG_HAS_IOMEM) && (defined(CONFIG_ARCH_S5PC1XX) || defined(CONFIG_ARCH_S3C64XX) || defined(CONFIG_CPU_S3C2443)))
  #define CONFIG_SERIAL_SAMSUNG_UARTS 4
#endif
#if (defined(CONFIG_ARM) && defined(CONFIG_PLAT_S3C) && defined(CONFIG_HAS_IOMEM) && (!defined(CONFIG_ARM) || !defined(CONFIG_PLAT_S3C) || !defined(CONFIG_HAS_IOMEM) || (!defined(CONFIG_ARCH_S5PC1XX) && !defined(CONFIG_ARCH_S3C64XX) && !defined(CONFIG_CPU_S3C2443))))
...
#endif
#if (!defined(CONFIG_MMU) && defined(CONFIG_REMAP_VECTORS_TO_RAM) && !defined(CONFIG_CPU_HIGH_VECTOR))
  #define CONFIG_VECTORS_BASE 0x00800000
#endif
#if (!defined(CONFIG_MMU) && !defined(CONFIG_CPU_HIGH_VECTOR) && (defined(CONFIG_MMU) || !defined(CONFIG_REMAP_VECTORS_TO_RAM)))
